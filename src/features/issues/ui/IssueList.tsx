...
import { type Issue, type IssueFilterState, type IssueSortOption, type Trigger } from "../model";
...
const TAG_JUDICIARY: Tag = { id: "t4", name: "사법", type: "category", slug: "judiciary" };
const TAG_LABOR: Tag = { id: "t5", name: "노동", type: "category", slug: "labor" };

// Mock 트리거
const TRIGGER_BUDGET_PASS: Trigger = {
	id: "tr1",
	issueId: "i1",
...
const TRIGGER_BUDGET_REVISION: Trigger = {
	id: "tr2",
	issueId: "i1",
...
const TRIGGER_FARE_INCREASE: Trigger = {
	id: "tr3",
	issueId: "i2",
...
const TRIGGER_COURT_RULING: Trigger = {
	id: "tr4",
	issueId: "i3",
...
const MOCK_ISSUES: Issue[] = [
	{
		...
		status: "ongoing",
		tags: [TAG_POLITICS],
		triggers: [TRIGGER_BUDGET_PASS, TRIGGER_BUDGET_REVISION],
		trackerCount: 1234,
		relatedEventIds: ["e1"],
	...
	},
	{
		...
		status: "ongoing",
		tags: [TAG_SOCIETY],
		triggers: [TRIGGER_FARE_INCREASE],
		trackerCount: 892,
		relatedEventIds: ["e2"],
	...
	},
	{
		...
		status: "closed",
		tags: [TAG_JUDICIARY, TAG_LABOR],
		triggers: [TRIGGER_COURT_RULING],
		trackerCount: 2156,
		relatedEventIds: ["e6"],
		sources: [{ url: "#", title: "대법원 판결", publisher: "법률신문", publishedAt: "2026-02-14" }]
	},
